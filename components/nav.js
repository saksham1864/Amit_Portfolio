  ...
  return (
    <nav className="fixed top-0 left-0 w-full  p-4 ">
      <div className="flex justify-between items-center">
        <div className="text-white text-lg font-bold">Soulful Living</div>
        ...
        <div className={`lg:flex lg:items-center lg:w-auto ${isOpen ? 'block' : 'hidden'} w-full lg:w-auto`}>
          <div className="text-sm lg:flex-grow">
            ...
            <a href="#featured" className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-gray-400 mr-4">
              Featured
            </a>
